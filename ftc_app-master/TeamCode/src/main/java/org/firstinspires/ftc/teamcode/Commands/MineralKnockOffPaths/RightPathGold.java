...
public class RightPathGold implements iCommand {
    private int runSequence;

    private CommandManager commandManager;

    public RightPathGold(int _runSequence){
        runSequence = _runSequence;
        commandManager = new CommandManager();
    }

    public void Init() {
        //drive to the gold cube in Right Position
        ...
        commandManager.AddCommand(new TurnByGyro(7, DriveBase.TURN_SPEED, -45));

        //drop off the marker
        commandManager.AddCommand(new DropMarker(8));

        commandManager.AddCommand(new TurnByGyro(9, DriveBase.TURN_SPEED, -125));

        //drive to the crater from depot
        commandManager.AddCommand(new DriveByGyro(10,DriveBase.DRIVE_SPEED, 16.25));
        commandManager.AddCommand(new TurnByGyro(11,DriveBase.TURN_SPEED,-130));
        ...
        commandManager.AddCommand(new DriveByGyro(14,DriveBase.DRIVE_SPEED, 16.25));
        commandManager.AddCommand(new TurnByGyro(15,DriveBase.TURN_SPEED,-135));
        commandManager.AddCommand(new DriveByGyro(16,DriveBase.DRIVE_SPEED, 25));
